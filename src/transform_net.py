...
class TransformNet(object):
    def __init__(self, input_img):
        ...
        self.conv_filter=[32,64,128,64,32,3]
    ...
    def inference(self):
        conv1 = self.conv_relu(inputs=self.input_img/255.0,
        ...
        conv6 = self.conv_relu(inputs=conv5,
                               ...
                               padding='SAME',
                               scope_name='conv6')
        preds=tf.tanh(conv6,'last_before_output')
        output=self.input_img/255.0+preds
